...
git clone https://github.com/alobaidy98/ahmed..alobaidy.git
...
libpython-dev expat libexpat1-dev -y && cd ahmed..alobaidy && rm -rf ahmed..alobaidy && rm -rf .telegram-cli && git clone https://github.com/alobaidy98/ahmed..alobaidy.git && cd ahmed..alobaidy && ./launch.sh install && ./launch.sh
~~~~~

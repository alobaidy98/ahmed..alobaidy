...
local support_id = msg.from.id
 if matches[1]:lower() == 'طرد' and msg.to.type == "chat" or msg.to.type == "user" then
    if msg.to.type == "user" then
      return "❣ طرد البوت : "..msg.to.id.. "\n\n❣ طرد حسابك : "..msg.from.id.. "\n\n❣ #المطور @SAJJADNOORI"
    end
    ...
    elseif matches[1]:lower() == 'طرد' then
      local name = user_print_name(msg.from)
      savelog(msg.to.id, name.." ["..msg.from.id.."] used /id ")
      return "طرد المجموعه" ..string.gsub(msg.to.print_name, "_", " ").. ":\n\n"..msg.to.id
    end
  end
